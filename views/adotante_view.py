class AdotanteView():
  ...
  def pega_dados_adotante(self):
    ...
    return {"nome": nome, "cpf": cpf, "data_nascimento": data_nascimento, "tipo_habitacao": tipo_habitacao, "tamanho_habitacao": tamanho_habitacao, "possui_animal": possui_animal, "logradouro": logradouro, "numero": numero}
  ...
  def mostra_adotante(self, dados_adotante):
    ...
    print("\t- TIPO DE HABITACAO DO ADOTANTE:", dados_adotante["tipo_habitacao"].name)
    print("\t- TAMANHO DE HABITACAO DO ADOTANTE:", dados_adotante["tamanho_habitacao"].name)
